        ...
        try
        {
            for (uint index = 0; ; index++)
            {
                ...
                try
                {
                    ...
                    if (!MatchesInstance(expectedInstance, instance.ToString())) continue;
                    ...
                    if (handle.IsInvalid) throw new Win32Exception(Marshal.GetLastWin32Error(), "Cannot open the recorded disk interface.");
